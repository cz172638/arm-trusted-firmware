...
#define RK3308_CPU_AXI_SAVE_QOS(array, base) do { \
...
#define RK3308_CPU_AXI_RESTORE_QOS(array, base) do { \
...
#define SAVE_QOS(array, NAME) \
	RK3308_CPU_AXI_SAVE_QOS(array, CPU_AXI_##NAME##_QOS_BASE)
#define RESTORE_QOS(array, NAME) \
	RK3308_CPU_AXI_RESTORE_QOS(array, CPU_AXI_##NAME##_QOS_BASE)
