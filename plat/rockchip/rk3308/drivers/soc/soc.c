...
#define RK3308_DEV_RNG0_BASE	0xff000000
#define RK3308_DEV_RNG0_SIZE	0x00ff0000

const mmap_region_t plat_rk_mmap[] = {
	MAP_REGION_FLAT(RK3308_DEV_RNG0_BASE, RK3308_DEV_RNG0_SIZE,
...
void rk3308_soc_reset_config(void)
{
	uint32_t tmp;
